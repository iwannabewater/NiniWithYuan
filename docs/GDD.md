...
v1.9.0 keeps the fifteen-chapter structure and core physics under **宋式星图器物幻想 / Song-atlas Night Observatory**. The release reduces competing ornament, clarifies control feedback, and blends presentation poses without changing routes or abilities. The original five chapters form World 1, **第一星域 破碎星图**. World 2, **第二星域 星门群岛**, contains five paired-star-gate chapters. World 3, **第三星域 星潮镜域**, contains five handcrafted chapters built around phase-tide bridges, route timing, and readable two-phase traversal without a hard postgame difficulty spike.
