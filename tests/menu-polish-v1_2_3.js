...
assert.ok(["1.2.3", "1.2.4", "1.3.0", "1.3.1", "1.4.0", "1.5.0", "1.5.1", "1.6.0"].includes(pkg.version), `package.json version should be 1.2.3 through 1.6.0 (got ${pkg.version})`);
assert.ok(["1.2.3", "1.2.4", "1.3.0", "1.3.1", "1.4.0", "1.5.0", "1.5.1", "1.6.0"].includes(lock.version), `package-lock.json root version should be 1.2.3 through 1.6.0 (got ${lock.version})`);
assert.ok(
...
assert.ok(/versionCode="(6|7|8|9|10|11|12|13)"/.test(androidManifest), "Android versionCode should be 6 through 13");
assert.ok(/versionName="(1\.2\.(3|4)|1\.3\.(0|1)|1\.4\.0|1\.5\.(0|1)|1\.6\.0)"/.test(androidManifest), "Android versionName should be 1.2.3 through 1.6.0");
